...
- error → "ดูรูปไม่สำเร็จครับ ({type})" · สำเร็จ → `files._log_activity("analyze_image", path, True)`
...
**เบราว์เซอร์จริง:** "จาร์วิส อ่านลิงก์นี้ให้หน่อย \<url\>" → สรุปเป็นเสียง · "ดูรูป screenshot.png ว่าเขียนอะไร" → ตอบเป็นเสียง
