...
export function addLinkLine(url) {
  ...
  div.className = 'jarvis-link';
  const a = document.createElement('a');
  a.href = url;
  a.target = '_blank';
  a.rel = 'noopener noreferrer';
  a.textContent = 'เบราว์เซอร์บล็อกการเปิดแท็บอัตโนมัติ — กดตรงนี้เพื่อเปิดเองครับ';
  div.appendChild(a);
  log.appendChild(div);
...
// "ไม่มีอะไรเกิดขึ้นเลย" ทั้งที่ จาร์วิส พยายามแจ้งเตือนแล้วจริงๆ (นี่คือบั๊กจริงที่เจอ)
