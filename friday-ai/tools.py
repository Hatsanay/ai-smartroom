...
# ไฟล์ log กิจกรรมเกี่ยวกับข้อมูลในเครื่อง — ผู้ใช้ขอไว้เป็นกลไกความโปร่งใส เพราะตอนนี้ FRIDAY แก้ไข/
# ลบไฟล์ได้จริงแล้ว (ไม่ใช่แค่อ่าน) เก็บไว้ที่ friday-ai/logs/ (แยกจากโฟลเดอร์ที่ผู้ใช้เลือก ตั้งใจไม่
...
def list_files(subpath: str = "") -> str:
    """แสดงรายชื่อไฟล์/โฟลเดอร์ในโฟลเดอร์ที่ผู้ใช้อนุญาตให้ FRIDAY เข้าถึงได้เท่านั้น (ตั้งค่าจากปุ่ม
...
def read_file(path: str) -> str:
    """อ่านเนื้อหาไฟล์ข้อความ — จำกัดแค่ไฟล์ในโฟลเดอร์ที่ผู้ใช้อนุญาตให้ FRIDAY เข้าถึงได้เท่านั้น
...
def create_folder(path: str) -> str:
    ...
    FRIDAY เข้าถึงได้เท่านั้น ใช้เมื่อผู้ใช้ขอให้สร้างโฟลเดอร์ใหม่
...
def write_file(path: str, content: str) -> str:
    ...
    ผู้ใช้อนุญาตให้ FRIDAY เข้าถึงได้เท่านั้น ใช้เมื่อผู้ใช้ขอให้สร้างไฟล์ใหม่หรือแก้ไขเนื้อหาไฟล์เดิม
...
def delete_path(path: str) -> str:
    ...
    อนุญาตให้ FRIDAY เข้าถึงได้เท่านั้น ใช้เมื่อผู้ใช้ขอให้ลบไฟล์/โฟลเดอร์ **อย่างชัดเจนเท่านั้น**
