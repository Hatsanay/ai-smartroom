...
ทุกอย่างอยู่ในโฟลเดอร์นี้ (jarvis-ai) ทุกคำสั่งด้านล่างให้รันจากที่นี่


เริ่มเร็ว (Windows) — แค่ 2 ไฟล์ .bat ในโฟลเดอร์นี้
--------------------------------------------------
...
1. เข้าไปที่โฟลเดอร์โปรเจกต์
     cd jarvis-ai        (โฟลเดอร์นี้ = ตัวโปรเจคเลย ไม่มีโฟลเดอร์ย่อย)
...
5. ทำไฟล์ .env จากไฟล์ตัวอย่าง (อยู่ในโฟลเดอร์ โฟลเดอร์เดียวกับ server.py)
...
- หน้าเว็บจะเปิดโหมด "ฟังตลอด" (wake word พูดคำว่า "จาร์วิส") เป็นค่าเริ่มต้นทันที เบราว์เซอร์จะขอ
  สิทธิ์ไมโครโฟนเอง
- Jarvis จำเรื่องผู้ใช้ / งาน / การเตือน ไว้ในไฟล์ jarvis.db (SQLite, สร้างเองอัตโนมัติ,
...
- รายละเอียดสถาปัตยกรรม เหตุผลการออกแบบ และ decision ต่างๆ ทั้งหมดอยู่ใน CLAUDE.md
