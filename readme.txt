...
โปรเจกต์หลักอยู่ในโฟลเดอร์ jusmin-ai/ (setup.bat / dev.bat / deploy.bat อยู่ในนั้นด้วย)
ทุกคำสั่งด้านล่างให้รันจากในโฟลเดอร์นั้น


เริ่มเร็ว (Windows) — แค่ 2 ไฟล์ .bat ในโฟลเดอร์ jusmin-ai
--------------------------------------------------
