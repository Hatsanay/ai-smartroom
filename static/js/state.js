...
export const S = {
  engagedActive: false, // ได้ยิน "จาร์วิส" แล้ว -> สีเขียว + โชว์แชท (voice/chat เขียน, wave อ่าน)
  ttsSpeaking: false, // จาร์วิส กำลังพูด (sound เขียน, wave/voice/youtube อ่าน)
